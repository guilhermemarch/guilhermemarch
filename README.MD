...
I have experience in **Java + Spring Boot**, developing **RESTful APIs**, integrating **microservices** using **RabbitMQ** and **Kafka**, and working with **containerized environments** using **Docker**.
